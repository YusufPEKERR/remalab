...
ROWS = [
    ...
    {"order": 108, "code": "106_109", "parent": 106, "child": 109, "positive": True, "user_change": True,
     "k1": "Müşteri onayına sunulacak", "k2": "Üretim aşamasında", "k3": None, "to": "MNG1_AS",
     "short_name": "Müşteri Onayı Geldi (Kabul)", "desc": "Müşteri onayına sunulacak > Üretim aşamasında.(106>109)", "enabled": True},
    {"order": 109, "code": "106_124", "parent": 106, "child": 124, "positive": True, "user_change": True,
     "k1": "Müşteri onayına sunulacak", "k2": "Son Teste teslim edilecek", "k3": None, "to": "MNG1_AS",
     "short_name": "Müşteri Onayı Geldi (Red)", "desc": "Müşteri onayına sunulacak > Son Teste teslim edilecek.(106>124)", "enabled": True},
    ...
    {"order": 102, "code": "107_136", "parent": 107, "child": 136, "positive": True, "user_change": True,
     ...
     "short_name": "Üretim Kaydını Görüntüle", "desc": "Müşteri onayı bekleniyor > Müşteri Onay/Red Geldi.(107>136)", "enabled": True},
