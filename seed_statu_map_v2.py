...
ROWS = [
    ...
    {"order": 4, "code": "102_104", "parent": 102, "child": 104, "positive": True, "user_change": False,
     ...
     "short_name": "Son test için kabul", "desc": "İlk teste aktarıldı > İlk test tamamlandı.(102>104)", "enabled": True},
    ...
    {"order": 9, "code": "125_109", "parent": 125, "child": 109, "positive": False, "user_change": True,
     ...
     "short_name": "Son test dönüş", "desc": "Son teste kabul yapıldı > Üretim aşamasında.(125>109)", "enabled": True},
    ...
    {"order": 7, "code": "105_109", "parent": 105, "child": 109, "positive": True, "user_change": True,
     ...
     "short_name": "Üretime aktar", "desc": "Üretim planına kabul bekleniyor > Üretim aşamasında.(105>109)", "enabled": True},
    {"order": 10, "code": "105_134", "parent": 105, "child": 134, "positive": True, "user_change": False,
     ...
     "short_name": "Rma kontrole aktar", "desc": "Üretim planına kabul bekleniyor > RMA kontrol.(105>134)", "enabled": True},
    ...
    {"order": 13, "code": "109_105", "parent": 109, "child": 105, "positive": False, "user_change": True,
     ...
     "short_name": "Farklı departmana sevk et", "desc": "Üretim aşamasında > Üretim planına kabul bekleniyor.(109>105)", "enabled": True},
    ...
    {"order": 19, "code": "127_128", "parent": 127, "child": 128, "positive": True, "user_change": False,
     ...
     "short_name": "Çıkışını yap", "desc": "Müşteri için sevk bekliyor > Çıkışı yapıldı.(127>128)", "enabled": True},
    ...
    {"order": 25, "code": "135_125", "parent": 135, "child": 125, "positive": True, "user_change": True,
     ...
     "short_name": "Son teste gönder", "desc": "İade için son teste gönderildi > Son teste kabul yapıldı.(135>125)", "enabled": True},
    {"order": 100, "code": "134_105", "parent": 134, "child": 105, "positive": False, "user_change": True,
     ...
     "short_name": "RMA reddedildi", "desc": "RMA kontrol > Üretim planına kabul bekleniyor.(134>105)", "enabled": True},
    {"order": 99, "code": "134_109", "parent": 134, "child": 109, "positive": True, "user_change": True,
     ...
     "short_name": "RMA kabul edildi", "desc": "RMA kontrol > Üretim aşamasında.(134>109)", "enabled": True},
    ...
    {"order": 102, "code": "107_136", "parent": 107, "child": 136, "positive": True, "user_change": True,
     ...
     "short_name": "Müşteri Onay/Red Geldi", "desc": "Müşteri onayı bekleniyor > Müşteri Onay/Red Geldi.(107>136)", "enabled": True},
    {"order": 103, "code": "103_105", "parent": 103, "child": 105, "positive": True, "user_change": False,
     ...
     "short_name": "Test Yapılamıyor - Üretime Aktar", "desc": "İlk test bekleniyor > Üretim planına kabul bekleniyor.(103>105)", "enabled": True},
    {"order": 104, "code": "135_136", "parent": 135, "child": 136, "positive": True, "user_change": True,
     ...
     "short_name": "İade Edilmeyecek - Müşteri Onayı Geldi", "desc": "İade için son teste gönderildi > Müşteri Onay/Red Geldi.(135>136)", "enabled": True},
    ...
    {"order": 106, "code": "109_138", "parent": 109, "child": 138, "positive": True, "user_change": False,
     ...
     "short_name": "Ara Test için Teslim al", "desc": "Üretim aşamasında > Ara Test Bekleniyor.(109>138)", "enabled": True},
