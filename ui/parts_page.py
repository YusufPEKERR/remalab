...
class PartsPage(QWidget):
        ...
        try:
            ...
            try:
                ...
                for r_idx, row in enumerate(rows):
                    ...
                    del_btn.clicked.connect(lambda checked, p_id=row[0]: self._delete_part(p_id))
    ...
    def _add_part(self):
        ...
        if dialog.exec() == QDialog.Accepted:
            ...
            try:
                ...
                db = SessionLocal()
                try:
                    db.execute(text("INSERT INTO warehouse.parts (name) VALUES (:name);"), {"name": name})
                    db.commit()
                finally:
                    db.close()
                self._load_parts()
    ...
    def _delete_part(self, part_id: int):
        ...
        reply = QMessageBox.question(
            self, tr("db.delete"), tr("parts.confirm_delete"),
