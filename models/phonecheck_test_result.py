...
class PhonecheckTestResult(Base):
    ...
    test_stage = Column(String(50), nullable=False)
    test_type = Column(String(100), nullable=True)
    test_start_time = Column(String(100), nullable=True)
    test_end_time = Column(String(100), nullable=True)
    station_id = Column(String(100), nullable=True)
    working = Column(String(50), nullable=True)
    passed = Column(Text, nullable=True)
    failed = Column(Text, nullable=True)
    pending = Column(Text, nullable=True)
    test_result_1 = Column(String(255), nullable=True)
    test_result_2 = Column(String(255), nullable=True)
    test_result_3 = Column(String(255), nullable=True)
    test_result_4 = Column(String(255), nullable=True)
    test_result_5 = Column(String(255), nullable=True)
    test_result_6 = Column(String(255), nullable=True)
    test_result_7 = Column(String(255), nullable=True)
    test_result_8 = Column(String(255), nullable=True)
    test_result_9 = Column(String(255), nullable=True)
    test_result_10 = Column(String(255), nullable=True)
