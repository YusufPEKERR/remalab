...
export default function StockTransferModal({ isOpen, onClose, onTransfer, locations = [], systemLocations = [] }) {
  ...
  return (
    <div className="fixed inset-0 bg-[#9FADC9]/80 dark:bg-[#131B3A]/80 backdrop-blur-sm flex items-center justify-center z-[99] p-4 overflow-y-auto">
      <div className="bg-[#C6CEE2] dark:bg-[#1E2B5C] border border-slate-200 dark:border-slate-700 shadow-2xl rounded-2xl w-full max-w-lg animate-in fade-in zoom-in duration-200 my-8">
        ...
        <div className="px-6 py-4 border-b border-slate-200 dark:border-slate-700/50 flex justify-between items-center bg-slate-50 dark:bg-[#232F63] rounded-t-2xl">
          ...
          <button onClick={onClose} className="text-slate-400 hover:text-white transition-colors bg-[#C6CEE2] dark:bg-[#1E2B5C] p-1.5 rounded-lg border border-slate-200 dark:border-slate-700">
            <X size={18} />
          </button>
        </div>
          ...
          <div className="bg-slate-50 dark:bg-[#232F63] p-4 rounded-xl border border-slate-200 dark:border-slate-700/50">
            ...
            <form onSubmit={handleQrScan} className="relative">
              ...
              <input 
                ...
                className="w-full bg-[#C6CEE2] dark:bg-[#1E2B5C] border border-slate-300 dark:border-slate-600 rounded-lg pl-10 pr-4 py-2.5 text-slate-800 dark:text-slate-200 focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 shadow-sm"
              />
            </form>
          </div>
            ...
            <div className="space-y-4">
              <div>
                ...
                <select 
                  ...
                  className="w-full bg-[#C6CEE2] dark:bg-[#1E2B5C] border border-slate-700/70 rounded-lg px-3 py-2.5 text-slate-800 dark:text-slate-200 focus:outline-none focus:border-blue-500"
                >
              ...
              <div>
                ...
                <select 
                  ...
                  className="w-full bg-[#C6CEE2] dark:bg-[#1E2B5C] border border-slate-700/70 rounded-lg px-3 py-2.5 text-slate-800 dark:text-slate-200 focus:outline-none focus:border-blue-500 disabled:opacity-50"
                >
            ...
            <div className="space-y-4">
              <div>
                ...
                <select
                  ...
                  className="w-full bg-[#C6CEE2] dark:bg-[#1E2B5C] border border-slate-700/70 rounded-lg px-3 py-2.5 text-slate-800 dark:text-slate-200 focus:outline-none focus:border-yellow-500 disabled:opacity-50"
                >
                  <option value="">--- Lokasyon Seçin ---</option>
              ...
              <div className="grid grid-cols-[1fr_auto] gap-4 items-end">
                <div>
                  ...
                  <input 
                    ...
                    disabled={!productId}
                    className="w-full bg-[#C6CEE2] dark:bg-[#1E2B5C] border border-slate-700/70 rounded-lg px-3 py-2.5 text-slate-800 dark:text-slate-200 focus:outline-none focus:border-yellow-500 disabled:opacity-50 font-bold" 
                  />
                </div>
                <div className="pb-2">
