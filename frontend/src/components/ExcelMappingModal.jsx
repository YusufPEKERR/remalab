...
export default function ExcelMappingModal({ 
  ...
  return (
    <div className="fixed inset-0 bg-slate-900/80 backdrop-blur-sm flex items-center justify-center z-[9999] p-4">
      <div className="bg-white dark:bg-[#1e2330] border border-slate-200 dark:border-slate-700 shadow-2xl rounded-2xl w-full max-w-4xl max-h-[90vh] overflow-hidden flex flex-col animate-in fade-in zoom-in duration-200">
        ...
        <div className="p-6 overflow-y-auto flex-1">
          ...
          {!fileData ? (
            <div className="flex flex-col items-center justify-center py-20 px-4 border-2 border-dashed border-slate-200 dark:border-slate-700 rounded-xl bg-slate-50 dark:bg-[#242a38]/50">
                      ...
                      {dbColumns.map(dbCol => (
                        <tr key={dbCol} className="hover:bg-slate-800/20">
                          ...
                          <td className="px-4 py-3">
                            <select 
                              className="w-full bg-white dark:bg-[#1e2330] border border-slate-200 dark:border-slate-700 text-slate-800 dark:text-slate-200 text-sm rounded-lg px-3 py-2 focus:outline-none focus:border-blue-500"
        ...
        {fileData && (
          <div className="px-6 py-4 border-t border-slate-200 dark:border-slate-700/50 flex justify-end gap-3 bg-slate-50 dark:bg-[#242a38]">
            <button 
              onClick={onClose}
              className="px-5 py-2.5 text-slate-700 dark:text-slate-300 bg-white dark:bg-[#1e2330] hover:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-lg text-sm font-medium transition-colors"
            >
              İptal
            </button>
            <button 
