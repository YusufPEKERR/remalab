...
export default function DeliverPartPopover({ isOpen, position, partName, quantity, locations = [], onConfirm, onClose }) {
  ...
  return (
    <div
      ...
      className="z-[100] w-72 bg-[#C6CEE2] dark:bg-[#1E2B5C] border border-slate-200 dark:border-slate-700 shadow-2xl rounded-xl p-4 space-y-3 animate-in fade-in zoom-in-95"
    >
