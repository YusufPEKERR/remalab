  ...
  return (
    <>
      ...
      <div
        ...
        className="z-[100] w-64 bg-[#C6CEE2] dark:bg-[#1E2B5C] border border-slate-200 dark:border-slate-700 shadow-2xl rounded-xl overflow-hidden py-1.5 animate-menu-in select-none"
      >
        {items.map(item => (
          <button
            key={item.key}
