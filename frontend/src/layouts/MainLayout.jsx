...
export default function MainLayout() {
  ...
  const allowedPaths = {
    'admin': ['/dashboard', '/depo', '/irsaliye', '/work-orders', '/servis-onarim', '/supply-requests', '/raporlar', '/parts', '/part-categories', '/products', '/suppliers', '/locations', '/users', '/settings', '/departments', '/service-records', '/data-management', '/tedarik-talepleri', '/quality', '/refurbishment', '/priority', '/item-bom', '/batch-entry'],
