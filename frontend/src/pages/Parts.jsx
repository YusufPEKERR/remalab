  ...
  return (
    <div className="flex flex-col space-y-6 pb-12 text-[#16204A] dark:text-[#F6F8FF] max-w-[1600px] mx-auto animate-in fade-in duration-300">
      ...
      <div className="glass-card rounded-2xl shadow-md overflow-hidden flex flex-col">
          ...
          <table className="w-full text-left text-xs whitespace-nowrap">
            <thead className="bg-[#B5BFD8] dark:bg-[#1B2755] text-[#2E3650] dark:text-[#8892B5] font-semibold uppercase tracking-wider border-b border-[#8593B4] dark:border-[#24326A] sticky top-0 z-10">
              <tr>
                ...
                <th className="px-6 py-4 cursor-pointer select-none group hover:bg-[#C6CEE2]/60 dark:hover:bg-[#24326A]/60 transition-colors" onClick={() => handleSort('id')}>
                  <div className="flex items-center gap-1.5 text-[#16204A] dark:text-[#F6F8FF]">
                    ID
                    <ArrowUpDown size={12} className={`transition-colors ${sortConfig.key === 'id' ? 'text-[#8894D8]' : 'text-[#2E3650] opacity-40 group-hover:opacity-100'}`} />
                  </div>
                </th>
                <th className="px-6 py-4 cursor-pointer select-none group hover:bg-[#C6CEE2]/60 dark:hover:bg-[#24326A]/60 transition-colors" onClick={() => handleSort('item_code')}>
                  <div className="flex items-center gap-1.5 text-[#16204A] dark:text-[#F6F8FF]">
                    PARÇA KODU
                    <ArrowUpDown size={12} className={`transition-colors ${sortConfig.key === 'item_code' ? 'text-[#8894D8]' : 'text-[#2E3650] opacity-40 group-hover:opacity-100'}`} />
                  </div>
                </th>
                <th className="px-6 py-4 cursor-pointer select-none group hover:bg-[#C6CEE2]/60 dark:hover:bg-[#24326A]/60 transition-colors" onClick={() => handleSort('brand')}>
                  <div className="flex items-center gap-1.5 text-[#16204A] dark:text-[#F6F8FF]">
                    MARKA
                    <ArrowUpDown size={12} className={`transition-colors ${sortConfig.key === 'brand' ? 'text-[#8894D8]' : 'text-[#2E3650] opacity-40 group-hover:opacity-100'}`} />
                  </div>
                </th>
                <th className="px-6 py-4 cursor-pointer select-none group hover:bg-[#C6CEE2]/60 dark:hover:bg-[#24326A]/60 transition-colors" onClick={() => handleSort('model')}>
                  <div className="flex items-center gap-1.5 text-[#16204A] dark:text-[#F6F8FF]">
                    MODEL
                    <ArrowUpDown size={12} className={`transition-colors ${sortConfig.key === 'model' ? 'text-[#8894D8]' : 'text-[#2E3650] opacity-40 group-hover:opacity-100'}`} />
                  </div>
                </th>
                <th className="px-6 py-4 cursor-pointer select-none group hover:bg-[#C6CEE2]/60 dark:hover:bg-[#24326A]/60 transition-colors" onClick={() => handleSort('item_category')}>
                  <div className="flex items-center gap-1.5 text-[#16204A] dark:text-[#F6F8FF]">
                    PARÇA KATEGORİSİ
                    <ArrowUpDown size={12} className={`transition-colors ${sortConfig.key === 'item_category' ? 'text-[#8894D8]' : 'text-[#2E3650] opacity-40 group-hover:opacity-100'}`} />
                  </div>
                </th>
                <th className="px-6 py-4 cursor-pointer select-none group hover:bg-[#C6CEE2]/60 dark:hover:bg-[#24326A]/60 transition-colors" onClick={() => handleSort('part_type')}>
                  <div className="flex items-center gap-1.5 text-[#16204A] dark:text-[#F6F8FF]">
                    PARÇA TİPİ
                    <ArrowUpDown size={12} className={`transition-colors ${sortConfig.key === 'part_type' ? 'text-[#8894D8]' : 'text-[#2E3650] opacity-40 group-hover:opacity-100'}`} />
                  </div>
                </th>
                <th className="px-6 py-4 cursor-pointer select-none group hover:bg-[#C6CEE2]/60 dark:hover:bg-[#24326A]/60 transition-colors" onClick={() => handleSort('status')}>
                  <div className="flex items-center gap-1.5 text-[#16204A] dark:text-[#F6F8FF]">
                    PARÇA STATÜSÜ
                    <ArrowUpDown size={12} className={`transition-colors ${sortConfig.key === 'status' ? 'text-[#8894D8]' : 'text-[#2E3650] opacity-40 group-hover:opacity-100'}`} />
                  </div>
                </th>
            ...
            <tbody className="divide-y divide-[#8593B4] dark:divide-[#24326A]">
              {loading ? (
                <tr>
                  <td colSpan="9" className="px-6 py-8 text-center text-[#2E3650] dark:text-[#8892B5]">
                ...
                (parts || []).map((part) => {
                  ...
                  return (
                  <tr key={part.id} className={`hover:bg-[#C6CEE2]/70 dark:hover:bg-[#24326A]/70 transition-colors text-[#16204A] dark:text-[#F6F8FF] ${isChecked ? 'bg-blue-900/30 border-l-4 border-[#3B4C93]' : ''}`}>
                    ...
                    <td className="px-6 py-3.5 font-mono text-[#2E3650] dark:text-[#8892B5] text-[11px]">{part.id}</td>
                    <td className="px-6 py-3.5 font-semibold text-[#16204A] dark:text-[#F6F8FF]">
                    ...
                    <td className="px-6 py-3.5 font-semibold text-[#16204A] dark:text-[#F6F8FF]">{part.brand || '-'}</td>
                    <td className="px-6 py-3.5 text-[#3D4B86] dark:text-slate-300">{part.model || '-'}</td>
                    <td className="px-6 py-3.5">
                      {part.item_category && (
                        <span className="px-2.5 py-1 rounded-lg bg-[#C6CEE2] dark:bg-[#24326A] border border-[#8593B4] dark:border-[#3B4A85] text-blue-700 dark:text-blue-300 font-semibold text-xs">
                          {part.item_category}
                        </span>
                      )}
                    </td>
                    <td className="px-6 py-3.5 text-[#2E3650] dark:text-[#8892B5]">{part.part_type || '-'}</td>
                    <td className="px-6 py-3.5">
                    ...
                    <td className="px-6 py-3.5 text-center">
                      <div className="flex justify-center gap-2">
                        <button onClick={(e) => { e.stopPropagation(); handleOpenModal(part); }} className="p-1.5 text-[#2E3650] dark:text-[#8892B5] hover:text-[#8894D8] hover:bg-[#C6CEE2] dark:hover:bg-[#24326A] rounded-lg transition-colors cursor-pointer" title="Düzenle">
                          <Edit size={16} />
                        </button>
                        <button onClick={(e) => { e.stopPropagation(); handleDelete(part.id); }} className="p-1.5 text-[#2E3650] dark:text-[#8892B5] hover:text-red-400 hover:bg-red-500/20 rounded-lg transition-colors cursor-pointer" title="Sil">
                          <Trash2 size={16} />
                        </button>
                      </div>
                    </td>
        ...
        {/* Pagination Footer */}
        <div className="flex flex-col sm:flex-row justify-between items-center px-6 py-4 bg-[#B5BFD8] dark:bg-[#1B2755] border-t border-[#8593B4] dark:border-[#24326A] gap-4 shrink-0 text-xs text-[#2E3650] dark:text-[#8892B5]">
          <span>
            Toplam <strong className="text-[#16204A] dark:text-[#F6F8FF]">{totalCount.toLocaleString('tr-TR')}</strong> kayıttan <strong className="text-[#16204A] dark:text-[#F6F8FF]">{parts.length === 0 ? 0 : (currentPage - 1) * itemsPerPage + 1}-{Math.min(currentPage * itemsPerPage, totalCount)}</strong> arası gösteriliyor
          </span>
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="px-3 py-1.5 bg-[#B5BFD8] dark:bg-[#16204A] border border-[#8593B4] dark:border-[#3B4A85] rounded-xl text-xs font-bold text-[#16204A] dark:text-[#F6F8FF] hover:bg-[#C6CEE2] dark:hover:bg-[#24326A] disabled:opacity-40 transition-all cursor-pointer"
            >
              Önceki
            </button>
      ...
      {isModalOpen && (
        <div className="fixed inset-0 bg-slate-900/80 backdrop-blur-sm flex items-center justify-center z-[99] p-4">
          <div className="bg-[#C6CEE2] dark:bg-[#1E2B5C] border border-slate-200 dark:border-slate-700 shadow-2xl rounded-2xl w-full max-w-md max-h-[90vh] overflow-y-auto">
            ...
            <form onSubmit={handleSubmit} className="p-6 space-y-4">
              <div>
                ...
                <div className="relative">
                  <input
                    type="text" required
                    className="w-full bg-slate-50 dark:bg-[#232F63] border border-slate-200 dark:border-slate-700 rounded-lg pl-3 pr-10 py-2.5 text-slate-800 dark:text-slate-200 focus:outline-none focus:border-blue-500"
              ...
              <div className="pt-2 flex justify-end gap-3 mt-6 border-t border-slate-200 dark:border-slate-700/50">
                ...
                <button
                  ...
                  className={`mt-4 px-5 py-2.5 text-[#1B2755] dark:text-white rounded-lg transition-colors font-medium shadow-lg ${
