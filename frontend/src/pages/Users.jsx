    ...
    <div className="h-full flex flex-col space-y-6 overflow-hidden">
                ...
                filteredUsers.map((user) => (
                  <tr 
                    ...
                    className={`transition-colors cursor-pointer text-slate-700 dark:text-slate-300
                      ${selectedUserId === user.id ? 'bg-blue-600/10 border-l-2 border-blue-500' : 'hover:bg-slate-100 dark:bg-[#2a3142] border-l-2 border-transparent'}`}
                  >
      ...
      {isModalOpen && (
        <div className="fixed inset-0 bg-slate-50 dark:bg-[#0f1219]/80 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div className="bg-white dark:bg-[#1e2330] border border-slate-200 dark:border-slate-700 shadow-2xl rounded-2xl w-full max-w-sm overflow-hidden animate-in fade-in zoom-in duration-200">
