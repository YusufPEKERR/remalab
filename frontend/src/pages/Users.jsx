    ...
    <div className="flex flex-col space-y-6 pb-12 text-[#12141c] dark:text-[#F6F8FF] max-w-[1600px] mx-auto animate-in fade-in duration-300">
      ...
      <div className="glass-card rounded-2xl p-4 shadow-md flex flex-col md:flex-row gap-4 items-center justify-between">
        ...
        <div className="flex flex-wrap gap-2.5 shrink-0">
          ...
          <button onClick={handleEdit} disabled={!selectedUserId} className="flex items-center gap-2 bg-[#FFFFFF] dark:bg-[#1e222d] hover:bg-[#EFF1FA] dark:hover:bg-[#2e3545] border border-[#DCE1F1] dark:border-[#2e3545] text-[#12141c] dark:text-[#F6F8FF] px-4 py-2.5 rounded-xl text-xs font-semibold transition-all cursor-pointer disabled:opacity-40">
            <Edit size={15} className="text-blue-400" /> Düzenle
          </button>
          <button onClick={handleResetPassword} disabled={!selectedUserId} className="flex items-center gap-2 bg-[#FFFFFF] dark:bg-[#1e222d] hover:bg-[#EFF1FA] dark:hover:bg-[#2e3545] border border-[#DCE1F1] dark:border-[#2e3545] text-[#12141c] dark:text-[#F6F8FF] px-4 py-2.5 rounded-xl text-xs font-semibold transition-all cursor-pointer disabled:opacity-40">
            <Key size={15} className="text-amber-400" /> Şifre
          </button>
          <button onClick={handleDelete} disabled={!selectedUserId} className="flex items-center gap-2 bg-[#FFFFFF] dark:bg-[#1e222d] hover:bg-red-500/20 border border-[#DCE1F1] dark:border-[#2e3545] hover:border-red-500/30 text-[#12141c] dark:text-[#F6F8FF] hover:text-red-400 px-4 py-2.5 rounded-xl text-xs font-semibold transition-all cursor-pointer disabled:opacity-40">
      ...
      <div className="glass-card rounded-2xl shadow-md overflow-hidden flex flex-col">
        <div className="overflow-x-auto flex-1">
          <table className="w-full text-left text-xs whitespace-nowrap">
            <thead className="bg-[#F5F7FC] dark:bg-[#181a24] text-[#5A6685] dark:text-[#8892B5] font-semibold border-b border-[#DCE1F1] dark:border-[#1e222d] sticky top-0 uppercase tracking-wider text-xs z-10 select-none">
              <tr>
                ...
                <th className="px-6 py-4 w-20 cursor-pointer select-none group hover:bg-[#FFFFFF]/60 dark:hover:bg-[#1e222d]/60 transition-colors" onClick={() => handleSort('id')}>
              ...
              {/* Filtre Satırı */}
              <tr className="bg-slate-100/60 dark:bg-[#12141c]/50 border-b border-slate-200 dark:border-slate-700/50 backdrop-blur-sm">
                ...
                <td className="px-6 py-3">
                  <input
                    type="text"
                    placeholder="Ara..."
                    className="w-16 px-2.5 py-1.5 text-xs bg-white dark:bg-[#181a24] border border-slate-200 dark:border-slate-700 rounded-lg focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-500/10 text-slate-700 dark:text-slate-300 placeholder-slate-400/50 transition-all font-normal"
                ...
                <td className="px-6 py-3">
                  <input
                    type="text"
                    placeholder="Ara..."
                    className="w-full min-w-[110px] px-2.5 py-1.5 text-xs bg-white dark:bg-[#181a24] border border-slate-200 dark:border-slate-700 rounded-lg focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-500/10 text-slate-700 dark:text-slate-300 placeholder-slate-400/50 transition-all font-normal"
                ...
                <td className="px-6 py-3">
                  <input
                    type="text"
                    placeholder="Ara..."
                    className="w-full min-w-[120px] px-2.5 py-1.5 text-xs bg-white dark:bg-[#181a24] border border-slate-200 dark:border-slate-700 rounded-lg focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-500/10 text-slate-700 dark:text-slate-300 placeholder-slate-400/50 transition-all font-normal"
                ...
                <td className="px-6 py-3">
                  <input
                    type="text"
                    placeholder="Ara..."
                    className="w-full min-w-[100px] px-2.5 py-1.5 text-xs bg-white dark:bg-[#181a24] border border-slate-200 dark:border-slate-700 rounded-lg focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-500/10 text-slate-700 dark:text-slate-300 placeholder-slate-400/50 transition-all font-normal"
                ...
                <td className="px-6 py-3">
                  <select
                    className="w-full min-w-[110px] px-2 py-1.5 text-xs bg-white dark:bg-[#181a24] border border-slate-200 dark:border-slate-700 rounded-lg focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-500/10 text-slate-700 dark:text-slate-300 transition-all font-normal cursor-pointer"
                ...
                <td className="px-6 py-3">
                  <select
                    className="w-full min-w-[100px] px-2 py-1.5 text-xs bg-white dark:bg-[#181a24] border border-slate-200 dark:border-slate-700 rounded-lg focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-500/10 text-slate-700 dark:text-slate-300 transition-all font-normal cursor-pointer"
                ...
                <td className="px-6 py-3">
                  <select
                    className="w-full min-w-[120px] px-2 py-1.5 text-xs bg-white dark:bg-[#181a24] border border-slate-200 dark:border-slate-700 rounded-lg focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-500/10 text-slate-700 dark:text-slate-300 transition-all font-normal cursor-pointer"
                ...
                paginatedUsers.map((user) => {
                  ...
                  <tr 
                    ...
                    className={`transition-colors cursor-pointer text-slate-700 dark:text-slate-300
                      ${selectedUserId === user.id ? 'bg-blue-600/10 border-l-2 border-blue-500' : 'hover:bg-slate-100 dark:hover:bg-[#1e222d] border-l-2 border-transparent'}
        ...
        <div className="flex justify-between items-center px-6 py-4 bg-slate-50 dark:bg-[#181a24] border-t border-slate-200 dark:border-slate-700/50 shrink-0">
        ...
        <div className="fixed inset-0 bg-slate-50 dark:bg-[#12141c]/80 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div className="bg-white dark:bg-[#12141c] border border-slate-200 dark:border-slate-700 shadow-2xl rounded-2xl w-full max-w-md max-h-[90vh] flex flex-col overflow-hidden animate-in fade-in zoom-in duration-200">
            <div className="px-6 py-4 border-b border-slate-200 dark:border-slate-700/50 flex justify-between items-center bg-slate-50 dark:bg-[#181a24] shrink-0">
              ...
              <button onClick={() => setIsModalOpen(false)} className="text-slate-400 hover:text-slate-900 dark:text-white transition-colors bg-white dark:bg-[#12141c] p-1.5 rounded-lg border border-slate-200 dark:border-slate-700">
                <X size={18} />
              </button>
            </div>
            ...
            <form onSubmit={handleSubmit} className="flex-1 flex flex-col overflow-hidden">
                    ...
                    <div className="space-y-1.5">
                      ...
                      {isDeletingRole ? (
                        <div className="space-y-2 p-3 bg-red-500/5 rounded-xl border border-red-500/20">
                          ...
                          <div className="flex gap-2">
                            <select
                              className="flex-1 bg-slate-50 dark:bg-[#181a24] border border-slate-200 dark:border-slate-700 rounded-xl px-4 py-2 text-slate-800 dark:text-slate-200 focus:outline-none focus:border-red-500"
                              value={roleToDelete}
                        ...
                        <select
                          className="w-full bg-slate-50 dark:bg-[#181a24] border border-slate-200 dark:border-slate-700 rounded-xl px-4 py-2.5 text-slate-800 dark:text-slate-200 focus:outline-none focus:border-blue-500 disabled:opacity-50 disabled:cursor-not-allowed"
                          value={formData.role}
                          onChange={e => {
              ...
              <div className="p-6 bg-slate-50 dark:bg-[#181a24] border-t border-slate-200 dark:border-slate-700/50 flex justify-end gap-3 shrink-0">
                <button type="button" onClick={() => setIsModalOpen(false)} className="px-5 py-2.5 bg-slate-50 dark:bg-[#181a24] hover:bg-slate-100 dark:hover:bg-[#1e222d] text-slate-700 dark:text-slate-300 rounded-xl font-medium transition-colors border border-slate-300 dark:border-slate-600">İptal</button>
