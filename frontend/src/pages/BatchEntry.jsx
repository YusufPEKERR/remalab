  ...
  return (
    <div className="flex flex-col space-y-6 pb-12 text-[#12141c] dark:text-[#F6F8FF] max-w-[1600px] mx-auto animate-in fade-in duration-300">
        ...
        <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-3 shrink-0 flex-wrap">
            ...
            <button
              ...
              className="flex items-center gap-2 px-5 py-2.5 bg-[#00B2FF] hover:bg-[#1e222d] text-white rounded-xl text-xs font-bold transition-all shadow-md cursor-pointer"
            >
              <Plus size={16} />
              Yeni Batch Girişi
            </button>
      ...
      <div className="glass-card rounded-2xl shadow-md overflow-hidden flex flex-col">
        {/* Filter Bar */}
        <div className="p-4 border-b border-[#DCE1F1] dark:border-[#1e222d] bg-[#F5F7FC] dark:bg-[#181a24] flex flex-wrap items-center gap-3">
          <div className="relative flex-1 min-w-[240px]">
            ...
            <input
              ...
              className="w-full pl-9 pr-8 py-2 bg-white dark:bg-[#181a24] border border-slate-200 dark:border-slate-700 rounded-xl text-sm text-slate-800 dark:text-slate-200 focus:outline-none focus:border-blue-500 shadow-sm"
            />
            {searchTerm && (
              <button
          ...
          <div className="w-52">
            <select
              ...
              className="w-full px-3 py-2 bg-white dark:bg-[#181a24] border border-slate-200 dark:border-slate-700 text-slate-800 dark:text-slate-200 rounded-xl text-sm focus:outline-none focus:border-blue-500 shadow-sm cursor-pointer"
            >
            ...
            <tbody className="divide-y divide-slate-700/50">
              {loadingBatchSummary ? (
                ...
                paginatedSummary.map(rec => (
                  <tr key={rec.id} className={`hover:bg-slate-100 dark:hover:bg-[#1e222d] text-slate-700 dark:text-slate-300 transition-colors ${selectedIds.includes(rec.id) ? 'bg-blue-500/5 dark:bg-blue-500/10' : ''}`}>
        ...
        {/* Footer Pagination */}
        <div className="px-6 py-4 border-t border-slate-200 dark:border-slate-700/50 bg-slate-50 dark:bg-[#12141c] flex flex-wrap items-center justify-between text-xs text-slate-400">
          <div className="flex items-center gap-2">
            ...
            <select
              ...
              className="px-2 py-1 bg-white dark:bg-[#181a24] border border-slate-200 dark:border-slate-700 rounded-lg text-slate-800 dark:text-slate-200 font-medium cursor-pointer focus:outline-none"
            >
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-1.5">
              ...
              <input
                ...
                className="w-14 px-2 py-1 bg-white dark:bg-[#181a24] border border-slate-200 dark:border-slate-700 rounded-lg text-center font-bold text-slate-800 dark:text-slate-200 focus:outline-none focus:border-blue-500"
              />
      ...
      {isModalOpen && (
        <div className="fixed inset-0 bg-slate-900/80 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div className="bg-white dark:bg-[#12141c] border border-slate-200 dark:border-slate-700 shadow-2xl rounded-2xl w-full max-w-4xl max-h-[92vh] overflow-hidden flex flex-col">
            {/* Modal Header */}
            <div className="px-6 py-4 border-b border-slate-200 dark:border-slate-700 flex justify-between items-center bg-white dark:bg-[#12141c]">
            ...
            <div className="p-6 overflow-y-auto flex-1">
              {!editingRecord ? (
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-3.5">
                      ...
                      <div>
                        ...
                        <select
                          ...
                          className="w-full bg-white dark:bg-[#12141c] border border-slate-300 dark:border-slate-700/80 rounded-lg px-3 py-2 text-xs text-slate-900 dark:text-slate-100 focus:outline-none focus:border-blue-500 cursor-pointer"
                        >
                ...
                <div className="space-y-5">
                  {/* Info Header */}
                  <div className="flex flex-wrap items-center justify-between bg-slate-100 dark:bg-[#181a24] p-3.5 rounded-xl border border-slate-200 dark:border-slate-700">
                  ...
                  <div className="bg-slate-50 dark:bg-[#181a24] rounded-xl border border-slate-200 dark:border-slate-700/60 overflow-hidden shadow-sm">
                    ...
                    <div className="overflow-x-auto max-h-80">
                      <table className="w-full text-left text-xs whitespace-nowrap border-collapse">
                        <thead className="bg-slate-200/80 dark:bg-[#181a24] text-slate-700 dark:text-slate-200 uppercase tracking-wider sticky top-0 font-semibold border-b border-slate-300 dark:border-slate-700 text-[11px]">
                          <tr>
                        ...
                        <tbody className="divide-y divide-slate-200 dark:divide-slate-700/50">
                          {(excelFileData || []).map((row, idx) => {
                            ...
                            return (
                              <tr key={idx} className={`hover:bg-slate-100 dark:hover:bg-[#24316A] transition-colors ${hasErr ? 'bg-rose-500/10' : 'bg-white dark:bg-[#12141c]'}`}>
